...
class ModelNet(Dataset):
    ...
    def __getitem__(self, item):
        ...
        return pt, img, img_v,  target, target_vec, item
...
class modelnet_labeled(ModelNet):
    ...
    def __init__(self,indexs=None,dataset='ModelNet40',partition='train'):
        ...
        if self.dataset =='ModelNet40':
            num_classes=40
            dataset_dir='/home/new_disk_users/HOPE-fxed/HOPE/data/'
    ...
    def __getitem__(self, index):
        ...
        return pt, img, img_v,  target, target_vec, index
...
def get_modelnet(n_labeled, num_class):
    if num_class == 40:
        dataset = "ModelNet40"
        base_dataset = ModelNet(dataset = 'ModelNet40', num_points = 1024, num_classes=40, dataset_dir='/home/new_disk_users/HOPE-fxed/HOPE/data/',  partition='train')
    elif num_class == 10:
        dataset = "ModelNet10"
        base_dataset = ModelNet(dataset = 'ModelNet10', num_points = 1024, num_classes=10, dataset_dir='/home/new_disk_users/HOPE-fxed/HOPE/data/',  partition='train')
